...
const EventCard = () => {
  return (
    <div className="relative min-h-30 justify-center flex flex-col gap-4 p-4 rounded-xl bg-[#27201c] border border-app-primary/40 overflow-hidden group cursor-pointer">
      <div className="absolute top-0 left-0 w-1 h-full bg-app-primary"></div>
      <div className="flex items-center gap-4 relative z-10">
        <div className="flex flex-col items-center justify-center w-16 h-16 bg-app-primary rounded-lg shrink-0 text-[#181411]">
